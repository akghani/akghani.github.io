...
::: concise
- Teaching Macroeconomics, International Economics and Data Visualisation with *R*
...
- Preparation of the texts explaining the simulations
...
::: concise
- Programming of the applications in *R shiny*
- Writing selected chapters of the [online textbook](https://eng.mgwk.de/)
- Translation of applications and textbook from German to English
