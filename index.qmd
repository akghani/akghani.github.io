...
<body>
  ...
  <section class="skills" id="skills">
    <h2 class="heading">My Skills<span class="animate scroll" style="--i:1;"></span></h2>
  ...
  <section class="portfolio" id="projects">
    ...
    <div class="projects-grid">
      <div class="project-card">
        ...
        <p>Short description of your project. Possibly with a link to GitHub or a live demo.</p>
      </div>
      <div class="project-card">
        <strong>Project B</strong>
        <p>Another great project with a short, enticing summary.</p>
      </div>
      <div class="project-card">
        <strong>Project C</strong>
        <p>Third project – highlight interesting features or results.</p>
      </div>
    </div>
  </section>
  ...
  <footer class="footer">
    <div class="footer-text">
      <p>If you'd like to chat, message me at <a href="https://t.me/K1rsN7">Telegram✈️</a></p>
